                ...
                <div className="col-lg-8">
                  <div className="single-detail mt-50">
                    <img
                      ...
                      src="assets/imgs/page/blog/single/b8-s1.png"
                      alt="Agon"
                      width={900}
                      height={500}
                    />
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-4">
                        <img
                          ...
                          src="assets/imgs/page/blog/single/b8-s2.jpg"
                          alt="Agon"
                          height={380}
                        />
                      </div>
                    ...
                    <div className="row mt-45 mb-30">
                      <div className="col-lg-6">
                        <img
                          ...
                          src="assets/imgs/page/blog/single/b8-s3.jpg"
                          alt="Agon"
                          height={465}
                          width={420}
                        />
                      ...
                      <div className="col-lg-6">
                        <img
                          ...
                          src="assets/imgs/page/blog/single/b8-s4.png"
                          alt="Agon"
                          height={220}
                          width={450}
                        />
                        <img
                          className="img-responsive"
                          src="assets/imgs/page/blog/single/b8-s5.png"
                          alt="Agon"
                          height={220}
                          width={450}
                        />
...
export default dynamic(() => Promise.resolve(BlogSingle8), { ssr: false });
